const DEFAULT_STOPS: Array<{ t: number; r: number; g: number; b: number }> = [
  { t: 0.0, r: 33, g: 64, b: 154 }, // deep blue
  { t: 0.25, r: 30, g: 144, b: 223 }, // sky
  { t: 0.5, r: 120, g: 205, b: 85 }, // green
  { t: 0.75, r: 255, g: 230, b: 80 }, // yellow
  { t: 1.0, r: 234, g: 57, b: 49 }, // red
];
...
export function getColor(val: number, min: number, max: number, stops: typeof DEFAULT_STOPS = DEFAULT_STOPS): Color {
