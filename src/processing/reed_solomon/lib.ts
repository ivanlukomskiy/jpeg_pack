...
const GenericGF = function () { this.init.apply(this, arguments) };
GenericGF.prototype = {
...
const ReedSolomonEncoder = function () { this.init.apply(this, arguments) };
...
const ReedSolomonDecoder = function () { this.init.apply(this, arguments) };
